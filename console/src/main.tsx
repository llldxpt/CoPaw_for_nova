...
// Attach window.NovaPaw.chat (Chat customization), extend
// window.NovaPaw.host with hooks + fetch, attach window.NovaPaw.audit.
installHostSdk();
...
// the registry so `window.NovaPaw.modules.<page>` is populated soon after
