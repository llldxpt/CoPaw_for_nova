  ...
  const installMarketPlugin = (entry: MarketPluginEntry) => {
    ...
    osModal.confirm({
      ...
      content: t("os.appCompatibilityWarningContent", {
        defaultValue:
          "This app is labeled for NovaPaw {{labels}}. Your NovaPaw version is {{version}}. Installing it may cause errors. Continue?",
                      ...
                      title={
                        !isCompatible(entry)
                          ? t("os.appCompatibilityUnverified", {
                              defaultValue:
                                "Compatibility with your NovaPaw version is unverified.",
                            })
                          : undefined
                      }
                    >
