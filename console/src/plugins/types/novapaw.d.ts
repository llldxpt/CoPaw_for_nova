/**
 * plugins/types/novapaw.d.ts — stable public contract for plugin authors.
 *
 * Plugin TS projects (cloudpaw, novapaw-pet, …) should COPY this file into
 * their own `novapaw-host.d.ts` and uncomment the `declare global` block at
 ...
 *
 * Inside the host, the global `Window.NovaPaw` is declared in
...
export interface NovaPawChatNamespace {
  welcome: {
    set(
      pluginId: string,
      partial: Partial<{
...
export interface NovaPawHostNamespace {
...
export interface NovaPawAuditNamespace {
...
export interface NovaPawWindowNamespace {
  host: NovaPawHostNamespace;
...
// Plugin projects: uncomment this in your own novapaw-host.d.ts to type
// `window.NovaPaw.*` accesses in plugin code.
//
// declare global {
//   interface Window {
//     NovaPaw: NovaPawWindowNamespace;
//   }
// }
