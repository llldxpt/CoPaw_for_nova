...
describe("messageQueueStore", () => {
  ...
  it("STORAGE_PREFIX is 'novapaw:message-queue:'", () => {
    expect(STORAGE_PREFIX).toBe("novapaw:message-queue:");
  });

  it("getStorageKey concatenates prefix + sessionId", () => {
    expect(getStorageKey("abc")).toBe("novapaw:message-queue:abc");
  });
