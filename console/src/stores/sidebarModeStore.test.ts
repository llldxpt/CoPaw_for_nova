...
const STORAGE_KEY = "novapaw_sidebar_mode";
...
describe("sidebarModeStore", () => {
  ...
  it("persists to the 'novapaw_sidebar_mode' localStorage key", () => {
    useSidebarModeStore.getState().setMode("simple");
    expect(localStorage.getItem("novapaw_sidebar_mode")).toBe("simple");
  });
