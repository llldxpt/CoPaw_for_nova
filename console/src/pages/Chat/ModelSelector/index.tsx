...
export default function ModelSelector() {
  ...
  const [activeTab, setActiveTab] = useState<"pro" | "free">(
    () =>
      (localStorage.getItem("novapaw_model_selector_tab") as "pro" | "free") ||
      "pro",
  );
  const [collapsedProviders, setCollapsedProviders] = useState<Set<string>>(
    () => {
      try {
        const raw = localStorage.getItem("novapaw_model_selector_collapsed");
    ...
    <div className={styles.panel}>
      ...
      <div className={styles.tabBar}>
        <button
          ...
          onClick={() => {
            setActiveTab("pro");
            localStorage.setItem("novapaw_model_selector_tab", "pro");
          }}
        >
          PRO
        </button>
        <button
          ...
          onClick={() => {
            setActiveTab("free");
            localStorage.setItem("novapaw_model_selector_tab", "free");
          }}
        >
          FREE
        </button>
