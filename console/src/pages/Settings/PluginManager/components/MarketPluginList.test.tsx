...
function makePlugin(
  ...
  return {
    ...
    novapaw_compat_labels: novapawCompatLabels,
    locales: {
      en: {
...
describe("MarketPluginList", () => {
  ...
  it("shows the NovaPaw compatibility versions returned by the market", () => {
    hoisted.plugins.push(
      makePlugin("https://platform.agentscope.io/plugins/agentscope/demo", [
        "1.x",
        "2.x",
    ...
    expect(screen.getByText("NovaPaw 1.x, 2.x")).toBeInTheDocument();
  });
});
