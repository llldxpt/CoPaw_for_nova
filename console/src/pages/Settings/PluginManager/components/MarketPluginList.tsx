            ...
            <div className={styles.catalogRow} key={entry.id}>
              ...
              <div className={styles.catalogInfo}>
                <div className={styles.catalogNameRow}>
                  ...
                  {entry.novapaw_compat_labels &&
                    entry.novapaw_compat_labels.length > 0 && (
                      <Tag
                        color={isCompatible(entry) ? "green" : "orange"}
                        style={{ margin: 0, fontSize: 11 }}
                      >
                        {`NovaPaw ${entry.novapaw_compat_labels.join(", ")}`}
                      </Tag>
                    )}
                </div>
                {entry.locales && (
              ...
              <div className={styles.catalogActions}>
                ...
                <Tooltip
                  title={
                    !isCompatible(entry)
                      ? `This plugin is labeled for NovaPaw ${
                          entry.novapaw_compat_labels?.join(", ") ?? "unknown"
                        }; compatibility with NovaPaw ${
                          novapawVersion ?? "unknown"
                        } is unverified.`
                      : undefined
                  }
                >
                      ...
                      if (!isCompatible(entry)) {
                        Modal.confirm({
                          ...
                          content: t("pluginManager.compatWarningContent", {
                            defaultValue:
                              "This plugin is labeled for NovaPaw {{labels}}. Your NovaPaw version is {{version}}. Installing it may cause errors. Are you sure you want to continue?",
                            labels:
                              entry.novapaw_compat_labels?.join(", ") ??
                              "unknown",
                            version: novapawVersion ?? "unknown",
                          }),
                          okText: t(
