...
export function AgentModal({
  ...
  const selectedBackend = Form.useWatch("backend", form) ?? "novapaw";
  ...
  useEffect(() => {
    if (!open || selectedBackend !== "novapaw") return;
  ...
  return (
    ...
    >
      <Form form={form} layout="vertical" autoComplete="off">
        ...
        <Form.Item
          hidden={selectedBackend !== "novapaw"}
          label={t("agent.model")}
        ...
        >
          <Input
            placeholder="~/.novapaw/workspaces/my-agent"
        ...
        {selectedBackend === "novapaw" && mailMode === "personal" && (
          <>
            <Form.Item
        ...
        {selectedBackend === "novapaw" && mailMode === "dedicated" && (
          <>
            <Form.Item
              name={["mail_credential", "name"]}
        ...
        {selectedBackend === "novapaw" && mailMode && mailMode !== "none" && (
          <Form.Item
            name={["mail_push", "mode"]}
      ...
      <div
        style={{
          marginTop: 4,
          display: selectedBackend === "novapaw" ? undefined : "none",
        }}
      >
        <div
          style={{
