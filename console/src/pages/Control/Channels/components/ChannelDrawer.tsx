        ...
        return (
          <>
            ...
            <Form.Item
              name="device_name"
              label="Device Name"
              tooltip="A stable device identity for the Matrix client. Defaults to 'novapaw-worker' if left empty."
            >
              <Input placeholder="novapaw-worker" />
            </Form.Item>
            <Form.Item
              name="dm_disabled"
      ...
      case "wechat":
        return (
          <>
            ...
            >
              <Input placeholder="~/.novapaw/wechat_bot_token" />
            </Form.Item>
            <Form.Item name="media_dir" label={t("channels.wechatMediaDir")}>
              <Input placeholder={defaultMediaDir} />
            </Form.Item>
          ...
          <Button
            ...
            onClick={() => {
              const url =
                CHANNEL_DOC_EN_URLS[activeKey]! ||
                CHANNEL_DOC_ZH_URLS[activeKey]!;
              const isNovaPawDoc = url.includes(
                "novapaw.agentscope.io/docs/channels/",
              );
              const finalUrl =
                isNovaPawDoc && currentLang === "zh"
                  ? CHANNEL_DOC_ZH_URLS[activeKey]!
                  : CHANNEL_DOC_EN_URLS[activeKey]!;
