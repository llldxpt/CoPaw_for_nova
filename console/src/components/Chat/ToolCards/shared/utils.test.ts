...
describe("formatMemorySearch", () => {
  ...
  it("formats malformed memory search text without showing metadata prefix", () => {
    ...
    const malformedMemoryText =
      '[ { "path": "/Users/zz/.novapaw/workspaces/q88eWE/memory/2026-05-18.md", "start_line": 1, "end_line": 77, "score": 0.625, "snippet": "# 记忆与反思 - 2026-05-18\n\n## 项目信息\n\n项目名称：《弹幕逃生》4分钟短视频';
    const rawToolResult = JSON.stringify([
      {
        type: "text",
    ...
    expect(formattedResult).toContain(
      "### 1. /Users/zz/.novapaw/workspaces/q88eWE/memory/2026-05-18.md",
    );
