# -*- coding: utf-8 -*-
"""Built-in tool functions for NovaPaw agents.
...
are intentionally not re-exported — novapaw's react_agent does not
...
from .text_to_speech import text_to_speech  # noqa: E402
...
_STABLE_BROWSER_MODULE = (
    "novapaw.agents.tools.deprecated_browser.browser_control"
)
...
async def shutdown_browser_runtime() -> None:
    ...
    unified_links = sys.modules.get("novapaw.browser.runtime.links")
