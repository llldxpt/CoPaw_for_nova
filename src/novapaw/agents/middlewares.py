# -*- coding: utf-8 -*-
"""Native AgentScope 2.0 middleware implementations for NovaPaw.
...
AUTO_MEMORY_TURN_STATE_KEY = "novapaw_auto_memory_turn_state"
_AUTOMATION_MEMORY_SKIP_SOURCES = frozenset({"cron", "heartbeat"})
_TOOL_RESULT_METADATA_KEY = "novapaw_tool_result_metadata"
    ...
    * post-reply auto-memory scheduling
    ...
    def _message_tag(msg: "Msg") -> str:
        ...
        if not isinstance(metadata, dict):
            return ""
        return str(metadata.get(NOVAPAW_MESSAGE_TAG_KEY) or "")
