...
class LazyGroup(click.Group):
    ...
    def parse_args(self, ctx, args):
        """Treat ``novapaw .`` as bare TUI launch with a project dir."""
        args = list(args)
...
def _looks_like_project_path(value: str) -> bool:
    """Return True for path-like CLI tokens intended for ``novapaw`` TUI."""
...
@click.group(
    ...
    lazy_subcommands={
        "acp": ("novapaw.cli.acp_cmd", "acp_cmd", ".acp_cmd"),
        "app": ("novapaw.cli.app_cmd", "app_cmd", ".app_cmd"),
        "channels": (
            "novapaw.cli.channels_cmd",
            "channels_group",
            ".channels_cmd",
        ),
        "channel": (
        ...
        "daemon": ("novapaw.cli.daemon_cmd", "daemon_group", ".daemon_cmd"),
        "chats": ("novapaw.cli.chats_cmd", "chats_group", ".chats_cmd"),
        "chat": ("novapaw.cli.chats_cmd", "chats_group", ".chats_cmd"),
        "clean": ("novapaw.cli.clean_cmd", "clean_cmd", ".clean_cmd"),
        "cron": ("novapaw.cli.cron_cmd", "cron_group", ".cron_cmd"),
        "env": ("novapaw.cli.env_cmd", "env_group", ".env_cmd"),
        "init": ("novapaw.cli.init_cmd", "init_cmd", ".init_cmd"),
        "models": (
            "novapaw.cli.providers_cmd",
            "models_group",
            ".providers_cmd",
        ),
        "skills": ("novapaw.cli.skills_cmd", "skills_group", ".skills_cmd"),
        "tui": ("novapaw.cli.tui.launch", "tui_cmd", ".tui.launch"),
        "uninstall": (
            "novapaw.cli.uninstall_cmd",
            "uninstall_cmd",
            ".uninstall_cmd",
        ),
        "desktop": ("novapaw.cli.desktop_cmd", "desktop_cmd", ".desktop_cmd"),
        "update": ("novapaw.cli.update_cmd", "update_cmd", ".update_cmd"),
        "shutdown": (
            "novapaw.cli.shutdown_cmd",
            "shutdown_cmd",
            ".shutdown_cmd",
        ),
        "auth": ("novapaw.cli.auth_cmd", "auth_group", ".auth_cmd"),
        "agents": ("novapaw.cli.agents_cmd", "agents_group", ".agents_cmd"),
        "agent": ("novapaw.cli.agents_cmd", "agents_group", ".agents_cmd"),
        "plugin": (
            "novapaw.cli.plugin_commands",
            "plugin",
            ".plugin_commands",
        ),
        "task": ("novapaw.cli.task_cmd", "task_cmd", ".task_cmd"),
        "doctor": ("novapaw.cli.doctor_cmd", "doctor_cmd", ".doctor_cmd"),
        "auto": ("novapaw.cli.auto", "auto_group", ".auto"),
    },
)
@click.version_option(version=__version__, prog_name="NovaPaw")
...
def cli(ctx: click.Context, host: str | None, port: int | None) -> None:
    ...
    # Bare ``novapaw`` (no subcommand) opens the interactive terminal chat UI.
