# -*- coding: utf-8 -*-
"""CLI command: run NovaPaw app on a free port in a native webview window."""
...
def desktop_cmd(
    ...
    """Run NovaPaw app on an auto-selected free port in a webview window.
    ...
    window without conflicting with an existing NovaPaw app instance.
    """
    ...
    click.echo(f"Starting NovaPaw app on {url} (port {port})")
