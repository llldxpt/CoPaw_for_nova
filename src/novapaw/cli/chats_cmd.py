...
def chats_group() -> None:
    ...
    \b
    Examples:
      novapaw chats list                    # List all chats
      novapaw chats list --user-id alice    # Filter by user
      novapaw chats get <chat_id>           # View details
      novapaw chats create --session-id s1 --user-id u1
      novapaw chats delete <chat_id>        # Delete a chat
    """
...
def list_chats(
    ...
    Examples:
      novapaw chats list
      novapaw chats list --user-id alice
      novapaw chats list --channel discord
      novapaw chats list --user-id alice --channel discord
    """
...
def get_chat(
    ...
    \b
    CHAT_ID  Chat UUID, obtainable via `novapaw chats list`.
...
def create_chat(
    ...
    Inline creation examples:
      novapaw chats create --session-id "discord:alice" \\
...
def update_chat(
    ...
    \b
    Examples:
      novapaw chats update <chat_id> --name "Renamed Chat"
    """
    base_url = _base_url(ctx, base_url)
...
def delete_chat(
    ...
    \b
    Examples:
      novapaw chats delete 823845fe-dd13-43c2-ab8b-d05870602fd8
    """
    base_url = _base_url(ctx, base_url)
    with client(base_url) as c:
