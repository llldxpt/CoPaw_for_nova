...
a native filter code (modelscope today, novapaw once its codes are known)
...
CATEGORIES: list[_Category] = [
    {
        ...
        "novapaw": "engineering development",
    ...
    },
    {
        ...
        "novapaw": "automation integration",
        "modelscope": None,
