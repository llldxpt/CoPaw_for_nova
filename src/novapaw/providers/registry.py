...
NOVA_AI_MODELS: List[ModelInfo] = [
    ModelInfo(id="novachat", name="NovaChat"),
    ModelInfo(id="novarag", name="NovaRAG"),
]

NOVA_AI_CLUSTER_MODELS: List[ModelInfo] = [
    ModelInfo(id="novachat", name="NovaChat"),
    ModelInfo(id="novarag", name="NovaRAG"),
]
...
PROVIDER_NOVA_AI = ProviderDefinition(
    id="nova-ai",
    name="Nova AI",
...
PROVIDER_NOVA_AI_CLUSTER = ProviderDefinition(
    id="nova-ai-cluster",
    name="Nova AI (Cluster)",
    default_base_url="http://127.0.0.1:15050/v1",
    api_key_prefix="",
    models=NOVA_AI_CLUSTER_MODELS,
)
...
PROVIDERS: dict[str, ProviderDefinition] = {
    ...
    PROVIDER_NOVA_AI.id: PROVIDER_NOVA_AI,
    PROVIDER_NOVA_AI_CLUSTER.id: PROVIDER_NOVA_AI_CLUSTER,
}
