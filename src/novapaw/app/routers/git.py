...
_DEFAULT_GITIGNORE = """\
# Auto-generated by NovaPaw Coding Mode
...
# NovaPaw runtime / internal directories (not user content)
sessions/
missions/
ralph_loops/
memory/
...
# NovaPaw runtime files
chats.json
jobs.json
skill.json
*.skill.json.lock
.skill.json.lock
novapaw_file_metadata.json
