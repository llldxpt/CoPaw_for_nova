...
class BaseChannel(ABC):
    ...
    def doctor_connectivity_notes(
        ...
        *,
        ...
        """Optional ``novapaw doctor --deep`` reachability checks.
    ...
    def build_agent_request_from_user_content(
        ...
        Uses :mod:`novapaw.schemas` Message / Content types directly — no
    ...
    async def send_approval_notification(
        ...
        *,
        ...
        back to plain text.
        """
        from novapaw.schemas import AgentRequest, Event
