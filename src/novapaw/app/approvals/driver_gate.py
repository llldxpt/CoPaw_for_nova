# -*- coding: utf-8 -*-
"""NovaPaw application approval gate for Driver policy."""
...
class NovaPawDriverApprovalGate:
    """Bridge Driver policy approval requests into NovaPaw approval service."""

    async def request_approval(
        self,
        context: DriverInvocationContext,
    ) -> None:
        # Reuse NovaPaw's approval Future flow: this coroutine pauses until
