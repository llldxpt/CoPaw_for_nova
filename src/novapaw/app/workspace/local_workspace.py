# -*- coding: utf-8 -*-
"""NovaPawLocalWorkspace — routes tool management to ToolRegistry.

Subclasses AgentScope's :class:`LocalWorkspace` so that
:meth:`list_tools` returns NovaPaw's own tools (managed by
...
class NovaPawLocalWorkspace(AgentScopeLocalWorkspace):
    ...
    async def list_tools(  # type: ignore[override]
        ...
        *,
        ...
        """Return NovaPaw tools, replacing AgentScope built-ins.
