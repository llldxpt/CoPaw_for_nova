...
from .local_workspace import NovaPawLocalWorkspace
...
class Workspace:
    ...
    def __init__(self, agent_id: str, workspace_dir: str):
        ...
        self._local_workspace = NovaPawLocalWorkspace(
    ...
    @property
    def local_workspace(self) -> NovaPawLocalWorkspace:
