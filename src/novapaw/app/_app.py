...
# Console static dir: env, or novapaw package data (console), or cwd.
...
def _resolve_console_static_dir() -> str:
    ...
    # Shipped dist lives in novapaw package as static data (not a Python pkg).
...
if os.path.isdir(_CONSOLE_STATIC_DIR):
    ...
    @app.get("/novapaw-symbol.svg")
    def _console_icon():
        f = _console_path / "novapaw-symbol.svg"
        if f.is_file():
