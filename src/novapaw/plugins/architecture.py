...
class NovaPawVersionConstraint(BaseModel):
    """NovaPaw version compatibility range (left-closed, right-open).
...
class PluginManifest(BaseModel):
    ...
    novapaw_version: Optional[NovaPawVersionConstraint] = None
