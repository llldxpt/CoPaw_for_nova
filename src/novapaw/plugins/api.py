...
def get_tool_config(tool_name: str) -> Optional[Dict[str, Any]]:
    ...
    Example:
        >>> from novapaw.plugins import get_tool_config
...
class PluginApi:  # pylint: disable=too-many-public-methods
    ...
    def register_channel(
        ...
        ``novapaw.app.channels.base.BaseChannel`` with a ``channel``
    ...
    def register_tool(
        ...
        - Adds the function to ``novapaw.agents.tools`` module
        ...
        def _startup_register():
            try:
                import novapaw.agents.tools as tools_module
